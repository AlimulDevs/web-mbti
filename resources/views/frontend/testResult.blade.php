        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    Anda memiliki tipe kepribadian <strong>{{ $student->dimension_type }}</strong>. Berikut ini adalah
                    rekomendasi jurusan yang cocok untuk Anda:
                </div>
                ...
                <div id="printable-content">
                    ...
                    <div class="card mt-4 mb-3" style="max-width: 400px">
                        <p style="max-width: 400px">Berdasarkan perhitungan tersebut, <b>{{ $student->user->name }}</b>
                            cocok
            ...
            <div class="card-footer bg-light">
                <div class="small text-muted">
                    <i class="fas fa-info-circle me-1"></i> Tes MBTI ini akan membantu menentukan tipe kepribadian Anda
                    untuk merekomendasikan jurusan SMK yang sesuai.
                </div>
            </div>
        </div>
    </div>
