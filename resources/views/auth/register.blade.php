            ...
            <div class="card shadow">
                ...
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        <img src="{{ asset('img/test.png') }}" alt="MBTI SMK Logo" class="img-fluid" style="max-height: 80px;">
                        <h5 class="mt-3">Sistem Rekomendasi Jurusan SMK</h5>
                        <p class="text-muted">Daftar untuk mendapatkan rekomendasi jurusan yang sesuai dengan kepribadian Anda</p>
                    </div>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="school" name="school_name" placeholder="Nama sekolah Anda">
                                        </div>
